 ...
 * <code>com.badlogic.audio</code> is an AudioSource and <code>fft</code> is an FFT (one
 * of the derived classes of FourierTransform).
 *
 * <pre>
 * fft.forward(com.badlogic.audio.left);
 ...
 * <b>Windowing</b>
 * <p>
 * Windowing is the process of shaping the com.badlogic.audio samples before transforming them
 ...
 * the case of com.badlogic.audio sampled at 44100 Hz is 11025-22010 Hz. These
 ...
 */
public abstract class FourierTransformations {
    /**
     ...
     */
    FourierTransformations(int ts, float sr) {
        timeSize = ts;
        sampleRate = (int) sr;
     ...
     * example, with com.badlogic.audio that has a sample rate of 44100 Hz,
