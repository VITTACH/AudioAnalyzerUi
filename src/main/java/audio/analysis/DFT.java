 ...
 */
public class DFT extends FourierTransformations {
    /**
     * Constructs a DFT that expects com.badlogic.audio buffers of length <code>timeSize</code> that
     ...
     *
     * @param timeSize   the length of the com.badlogic.audio buffers you plan to analyze
     * @param sampleRate the sample rate of the com.badlogic.audio samples you plan to analyze
     */
