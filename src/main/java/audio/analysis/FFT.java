 ...
 * that when you want to analyze the spectrum of an com.badlogic.audio buffer you will almost always use
 * this class. One restriction of this class is that the com.badlogic.audio buffers you want to analyze
 ...
 * @see FourierTransformations
 * @see <a href="http://www.dspguide.com/ch12.htm">The Fast Fourier Transform</a>
 */
public class FFT extends FourierTransformations {
    /**
     ...
     * @param sampleRate the sample rate of the com.badlogic.audio you will be analyzing
     */
